...
train_path = '/home/aistudio/data/data59734/train.csv'
test_path = '/home/aistudio/data/data59734/test.csv'
valid_path = '/home/aistudio/data/data59734/valid.csv'
...
bert_path = '/home/aistudio/data/data56340/'
...
model_name = 'Bert'
save_path = '/home/aistudio/work/TextClassifier-main/model/bert_wo_cls_1.pt'
# bert
eps = 1e-8
...
freeze_bert = ""  # ""表示不冻结, "all"则是冻结BERT,["embeddings","encoder"]则是冻结对应层
freeze_layers = ""  # "1,2,3.."表示冻结对应层数
linear = False

# textcnn
textcnn = True
cls_learning_rate = 1e-3  # 学习率
kernel_sizes = (2, 3, 4)  # 卷积核尺寸
num_filters = 256
