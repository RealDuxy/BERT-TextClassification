...
from src.models.bert import Model
...
def train(config, model, train_iter, dev_iter, test_iter):
    ...
    optimizer_grouped_parameters = [{
        'params': [
            ...
            if not any(nd in n for nd in no_decay) and n.startswith('bert')
        ],
        'weight_decay':
            0.01,
        'lr':
            ...
            p for n, p in param_optimizer
            if not any(nd in n for nd in no_decay) and n.startswith('textcnn')
        ],
        'weight_decay':
            0.01,
        'lr':
        ...
        'params': [
            p for n, p in param_optimizer
            if any(nd in n for nd in no_decay) and n.startswith('bert')
        ],
        'weight_decay':
            0.0,
        'lr':
        ...
        'params': [
            p for n, p in param_optimizer
            if any(nd in n for nd in no_decay) and n.startswith('textcnn')
        ],
        'weight_decay':
            0.0,
        'lr':
